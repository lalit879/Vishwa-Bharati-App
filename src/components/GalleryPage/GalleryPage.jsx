...
const GalleryPage = () => {
  ...
  return (
    <>
      <Nav />
      <div className="bg-gray-50 mt-20 py-16 px-12 sm:px-12 lg:px-24">
        ...
        <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 cursor-pointer">
          {paginatedImages.map((img) => (
            <div
              key={img.id}
              className="aspect-square w-full rounded-lg overflow-hidden shadow hover:scale-105 transition-transform"
            >
              <img
                src={img.src}
                alt={img.alt}
