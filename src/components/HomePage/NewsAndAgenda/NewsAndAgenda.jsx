...
const NewsAndAgenda = () => {
  const newsItems = [
    {
      ...
      description: 'Lorem ipsum dolor sit amet adipiscing amet adipcingamet adipci aqua lorem ipsum.',
      date: '20 June',
    },
    {
      image: img2,
      title: 'Teaching and Learning Activities at Home',
      description: 'Lorem ipsum dolor sit amet adipcing ipsum dolor sit amet adipcing aqua lorem ipsum.',
      date: '20 June',
    },
    {
      image: img3,
  ...
  return (
    <section id='news' className="py-12 px-6 lg:px-20 bg-white">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">News and Agenda</h2>
